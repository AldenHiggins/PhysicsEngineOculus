...
static bool MainLoop(bool retryCreate)
{
	...
	// The window size will be the size of the mirror window
	ovrSizei windowSize = { (int)((float)(hmdDesc.Resolution.w) / 1.25f), (int)((float)(hmdDesc.Resolution.h) / 1.25f) };
...
int WINAPI WinMain(HINSTANCE hinst, HINSTANCE, LPSTR, int)
{
    ...
    VALIDATE(Platform.InitWindow(hinst, L"Physics Engine"), "Failed to open window.");
